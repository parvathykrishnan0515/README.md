...
## 👩‍💻 About Me
Cybersecurity enthusiast and recent computer science graduate with hands-on experience in security monitoring, threat detection, incident response, and network defence. I am passionate about analysing system behaviour, identifying anomalies, and supporting defensive operations using SIEM and network security tools.

I am actively seeking an entry-level role in a **Security Operations Center (SOC)** as a **Tier 1 SOC Analyst**, where I can contribute to threat monitoring, incident response, and continuous security improvement.

---

## 🎯 Objective
To secure a SOC Tier 1 Analyst position where I can apply my skills in security monitoring, log analysis, incident response, and threat detection while continuing to grow as a cybersecurity professional.
...
|------|-------------------|
| SIEM Implementation & Log Analysis | [Detection Lab](https://github.com/parvathykrishnan0515/SOC-Home-Lab1) |
...
| Scripting & Automation (Python) | SOC Automation Lab |
